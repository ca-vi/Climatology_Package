...
# this function needs the file paths to three input files of the biomet-station


read.biomet <- function (file_bm1, file_bm2, file_wm, all=F){ 
  ...
  if (all==T) {
    return(invisible(data))} 
      ...
      sel = c('TIMESTAMP', 'RECORD','SW_downwelling', 'SW_upwelling','SW_east','SW_west','SW_south', 'SW_north', 
